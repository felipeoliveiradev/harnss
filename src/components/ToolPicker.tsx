...
import { Terminal, Globe, GitBranch, FolderTree, ListTodo, Bot, Plug, Users, SquareArrowOutUpRight, ArrowDown, ArrowRight, Play, Search, Sparkles, MonitorPlay } from "lucide-react";
...
export type ToolId = "terminal" | "browser" | "git" | "files" | "project-files" | "tasks" | "agents" | "mcp" | "groups" | "executions" | "search" | "skills" | "preview";
